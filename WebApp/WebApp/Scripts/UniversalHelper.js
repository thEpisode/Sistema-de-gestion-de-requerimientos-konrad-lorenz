...
var UniversalHelper = (function () {
    ...
    this.slideOut = function (selector) {
        $(selector).animate({ "left": "-500px" }, { duration: 800, queue: false }, "easeOutExpo");
        $(selector).fadeOut(500);
    }

    this.slideIn = function (selector) {
        $(selector).css("left", "1500px");

        $(selector).animate({ "left": "0px" }, { duration: 800, queue: false }, "easeOutExpo");
        $(selector).fadeIn(800);
    }
